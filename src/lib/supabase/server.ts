...
// this file would use process.env instead of (import.meta as any).env.

import { createClient } from '@supabase/supabase-js'

export function createServerClient() {
  // Try to use process.env first for Node environments, fallback to (import.meta as any).env for Vite
  const supabaseUrl = 
