      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 md:mb-8 gap-4">
        <div>
          <h2 className="text-xl md:text-2xl font-bold tracking-tight italic text-white flex items-center gap-3">
            <Users className="h-5 w-5 md:h-6 md:w-6 text-indigo-500" /> Roster Governance
          </h2>
            ...
            <div className="mt-8 border-t border-zinc-900 pt-8">
              <div className="flex flex-col lg:flex-row justify-between gap-6 mb-6">
                ...
                <form
                  ...
                  className="flex flex-col sm:flex-row gap-4 sm:items-end bg-zinc-900/30 p-4 border border-zinc-900 w-full lg:w-1/2 shrink-0"
                >
